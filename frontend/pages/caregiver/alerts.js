...
export function createCaregiverAlertsPage(authState) {
  ...
  return `
    <div class="min-h-screen bg-[linear-gradient(180deg,#f8fbf8_0%,#f4f7fa_100%)] pb-24 font-body-md text-on-background">
      ...
      <nav class="fixed bottom-0 left-0 right-0 z-50 mx-auto flex h-20 w-full max-w-6xl items-center justify-around rounded-t-[24px] border-t border-outline-variant bg-white/95 px-2 pb-safe shadow-[0px_-4px_20px_rgba(0,0,0,0.04)] backdrop-blur">
